  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/70">
      <div className="relative z-[9999] bg-gradient-to-br from-black/90 via-black/80 to-black/90 border border-custume-orange/30 rounded-2xl p-8 max-w-md w-full shadow-2xl shadow-custume-orange/20">
        ...
        <button className="w-full px-6 py-3 bg-custume-orange text-black text-lg font-bold rounded-xl hover:bg-custume-orange/90 hover:scale-105 transition-all duration-300">
          Continue Shopping
        </button>
      </div>
    </div>
